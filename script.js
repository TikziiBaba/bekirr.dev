// ============================================
// bekirr.dev — Bekir Kaplan Clean Geometric Portfolio
// ============================================
    ...
    if (typeof gsap !== 'undefined' && typeof ScrollTrigger !== 'undefined') {
        ...
        if (window.innerWidth > 900) {
            ...
            masterTL.fromTo('#story-feature-1',
                { autoAlpha: 0, x: -160, scale: 0.8 },
                { autoAlpha: 1, x: 0, scale: 1, duration: 0.8, pointerEvents: 'auto' }, 1.8
            );
            masterTL.to('#story-feature-1', { autoAlpha: 0, x: -160, duration: 0.6, pointerEvents: 'none' }, 3.0);

            // Story Feature Card 2
            masterTL.fromTo('#story-feature-2',
                { autoAlpha: 0, x: 160, scale: 0.8 },
                { autoAlpha: 1, x: 0, scale: 1, duration: 0.8, pointerEvents: 'auto' }, 3.8
            );
            masterTL.to('#story-feature-2', { autoAlpha: 0, x: 160, duration: 0.6, pointerEvents: 'none' }, 5.0);

            // Story Feature Card 3
            masterTL.fromTo('#story-feature-3',
                { autoAlpha: 0, x: -160, scale: 0.8 },
                { autoAlpha: 1, x: 0, scale: 1, duration: 0.8, pointerEvents: 'auto' }, 5.8
            );
            masterTL.to('#story-feature-3', { autoAlpha: 0, x: -160, duration: 0.6, pointerEvents: 'none' }, 7.0);

            // Story Feature Card 4
            masterTL.fromTo('#story-feature-4',
                { autoAlpha: 0, x: 160, scale: 0.8 },
                { autoAlpha: 1, x: 0, scale: 1, duration: 0.8, pointerEvents: 'auto' }, 7.8
            );
            masterTL.to('#story-feature-4', { autoAlpha: 0, x: 160, duration: 0.6, pointerEvents: 'none' }, 9.0);
